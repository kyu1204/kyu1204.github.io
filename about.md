...
<div class="profile">
    <img class="profile-img" src="/assets/images/me.jpg" alt="python :)" />
    <div class="name"><b>김민규</b>/harry/해리</div>
</div>

[PURPLEWORKS](http://purpleworks.co.kr)+CREATIVE LAB

`python` `java` `go` `c#` `ubuntu` `docker` `elasticsearch` `tensorflow`
...
- <i class="nf nf-fa-github"></i> [github.com/kyu1204](https://github.com/kyu1204/)
- <i class="nf nf-oct-mail"></i> [pb1123love@gmail.com](mailto:pab1123love@gamil.com)

## Work

- 아크릴 / Software Engineer (2019~)
  - Python/Flask - Elasticsearch를 이용한 백엔드 개발
